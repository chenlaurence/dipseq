...
def SamtoolsIndex(in_fname):
    ...
    # LC added a -o for the samtools sort -o 200512
    # LC changed % in_fname to % bam_fname for the first command
...
def Main():
    ...
    # LC added "" string commands 200510 for the pattern inputs 
